  ...
  function create(docBase, docEditBase, title) {
    ...
    function generateHeader(title) {
      return header = [
        ...
        'onclick="EditOnGithubPlugin.onClick(event)"> <img src="https://github.githubassets.com/images/icons/emoji/unicode/1f4dd.png?v8.png" alt="memo" class="emoji" loading="lazy">',
        title,
        '</a></p>',
        '</div>'
      ].join('')
